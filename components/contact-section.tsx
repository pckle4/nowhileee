    ...
    <section id="contact" ref={sectionRef} className="py-20 lg:py-32 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div
            ref={formRef}
            className="bg-white/90 dark:bg-slate-800/70 backdrop-blur-md border border-gray-200/50 dark:border-slate-700/50 rounded-2xl p-8 shadow-xl opacity-0 translate-y-8 transition-all duration-700 ease-out"
          >
